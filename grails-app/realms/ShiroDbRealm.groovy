...
import com.system.ShiroUserPermissionRel
...
class ShiroDbRealm {
    ...
    def hasRole(principal, roleName) {
        def criteria = ShiroUserRoleRel.createCriteria()
    ...
    def isPermitted(principal, requiredPermission) {
        ...
        def roles = ShiroUserRoleRel.findAllByUser(user)
        ...
        criteria = ShiroRolePermissionRel.createCriteria()
